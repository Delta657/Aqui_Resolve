...
/**
 * Tela do cliente para a Central AquiResolve (Base ↔ Cliente).
 * Lista mensagens da `client_chats/{uid}/messages` e permite enviar resposta.
 */
class ClientCentralChatActivity : AppCompatActivity() {

    private val auth: FirebaseAuth = FirebaseAuth.getInstance()
    private val repository = CentralChatRepository()
    ...
    private fun sendMessage() {
        ...
        lifecycleScope.launch {
            ...
            if (result.isSuccess) {
                ...
                Toast.makeText(
                    this@ClientCentralChatActivity,
