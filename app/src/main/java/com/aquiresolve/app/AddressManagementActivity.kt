...
import com.aquiresolve.app.adapters.SavedAddressAdapter
import com.aquiresolve.app.databinding.ActivityAddressManagementBinding
...
class AddressManagementActivity : AppCompatActivity() {
    ...
    private var currentDialogBinding: com.aquiresolve.app.databinding.DialogAddAddressBinding? = null
     ...
     */
    private fun setupStateSpinner(dialogBinding: com.aquiresolve.app.databinding.DialogAddAddressBinding) {
    ...
    private fun showAddAddressDialog(address: String = "", coordinates: GeoPoint? = null) {
        val dialogBinding = com.aquiresolve.app.databinding.DialogAddAddressBinding.inflate(layoutInflater)
    ...
    private fun updateSelectedCoordsLabel(dialogBinding: com.aquiresolve.app.databinding.DialogAddAddressBinding?, coords: GeoPoint?) {
