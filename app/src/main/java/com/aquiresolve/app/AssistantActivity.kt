...
/**
 * Helô AquiResolve (plano 06). O cliente descreve o problema em linguagem natural e a IA
...
class AssistantActivity : AppCompatActivity() {
    ...
    private fun setVoiceListening(listening: Boolean) {
        ...
        binding.btnVoice.text = if (listening) "Ouvindo… toque para parar" else "Falar com o Helô"
    }
