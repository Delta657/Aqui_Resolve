...
object OrderDistributionManager {
    ...
    data class QueuedOrder(
        val orderId: String,
        val orderData: com.example.loginapp.models.OrderData,
     ...
     */
    suspend fun distributeOrder(order: com.example.loginapp.models.OrderData): DistributionResult {
     ...
     */
    private suspend fun distributeSimpleOrder(order: com.example.loginapp.models.OrderData): DistributionResult {
     ...
     */
    private suspend fun distributeComplexOrder(order: com.example.loginapp.models.OrderData): DistributionResult {
    ...
    private suspend fun assignToProvider(
        order: com.example.loginapp.models.OrderData,
        providerId: String,
        distance: Double
    ): DistributionResult {
     ...
     * Obtém pedido por ID
     */
    private fun getOrderById(orderId: String): com.example.loginapp.models.OrderData? {
